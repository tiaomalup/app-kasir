...
<body class="bg-orange-100 min-h-screen">
  ...
  <div class="flex flex-row pt-24 px-10 pb-4">
    ...
    <div class="w-2/12 mr-6">
      <div class="bg-white rounded-xl shadow-lg mb-6 px-6 py-4">
        <a href="{{ url('/dashboard') }}" class="inline-block text-orange-600 bg-orange-50 rounded-lg my-2 w-full p-2">
          <span class="material-icons-outlined float-left pr-2">dashboard</span>
          Home
          <span class="material-icons-outlined float-right">keyboard_arrow_right</span>
        </a>
        <a href="{{ url('/akun') }}" class="inline-block text-gray-600 hover:text-black hover:bg-gray-50 rounded-lg my-2 w-full p-2">
          <span class="material-icons-outlined float-left pr-2">people</span>
          Kelola Akun Kasir
          <span class="material-icons-outlined float-right">keyboard_arrow_right</span>
        </a>
        <a href="{{ url('/produk') }}" class="inline-block text-gray-600 hover:text-black hover:bg-gray-50 rounded-lg my-2 w-full p-2">
          <span class="material-icons-outlined float-left pr-2">storefront</span>
          Manajemen Produk
          <span class="material-icons-outlined float-right">keyboard_arrow_right</span>
        </a>
        <a href="{{ url('/transaksi') }}" class="inline-block text-gray-600 hover:text-black hover:bg-gray-50 rounded-lg my-2 w-full p-2">
          <span class="material-icons-outlined float-left pr-2">sync_alt</span>
          Pantau Transaksi
          <span class="material-icons-outlined float-right">keyboard_arrow_right</span>
        </a>
        <a href="{{ url('/laporan') }}" class="inline-block text-gray-600 hover:text-black hover:bg-gray-50 rounded-lg my-2 w-full p-2">
          <span class="material-icons-outlined float-left pr-2">bar_chart</span>
          Laporan Analitik
          <span class="material-icons-outlined float-right">keyboard_arrow_right</span>
        </a>
        <a href="{{ url('/log-activity') }}" class="inline-block text-gray-600 hover:text-black hover:bg-gray-50 rounded-lg my-2 w-full p-2">
      ...
      <div class="bg-white rounded-xl shadow-lg mb-6 px-6 py-4">
        <a href="{{ url('/profil') }}" class="inline-block text-gray-600 hover:text-black hover:bg-gray-50 rounded-lg my-2 w-full p-2">
    ...
    <div class="w-10/12">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div class="bg-white rounded-xl shadow p-4 flex items-center hover:shadow-lg transition-shadow">
          ...
          <div>
            ...
            <p class="text-xl font-bold text-blue-900">{{ number_format($totalPenjualan, 0, ',', '.') }}</p>
        ...
        <div class="bg-white rounded-xl shadow p-4 flex items-center hover:shadow-lg transition-shadow">
          ...
          <div>
            ...
            <p class="text-xl font-bold text-blue-900">{{ $pesananHariIni }}</p>
            <p class="text-xs text-gray-400">Rp {{ number_format($revenueHariIni, 0, ',', '.') }}</p>
          </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow p-4 flex items-center hover:shadow-lg transition-shadow">
          ...
          <div>
            ...
            <p class="text-xl font-bold text-blue-900">
              {{ $produkTerlaris ? $produkTerlaris->name : 'Belum Ada' }}
            </p>
            <p class="text-xs text-gray-400">
              {{ $produkTerlaris ? $produkTerlaris->total_quantity . ' pcs terjual' : '' }}
            </p>
          </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow p-4 flex items-center hover:shadow-lg transition-shadow">
          ...
          <div>
            ...
            <p class="text-xl font-bold text-blue-900">Rp {{ number_format($pendapatanBulanIni, 0, ',', '.') }}</p>
            <p class="text-xs text-gray-400">{{ Carbon\Carbon::now()->format('F Y') }}</p>
          </div>
        </div>
      </div>
        ...
        <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow p-4 text-white">
          <div class="flex justify-between items-center">
            <div>
              ...
              <p class="text-2xl font-bold">{{ $statistics['total_products'] }}</p>
            </div>
        ...
        <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-xl shadow p-4 text-white">
          <div class="flex justify-between items-center">
            <div>
              ...
              <p class="text-2xl font-bold">{{ $statistics['total_kasir'] }}</p>
            </div>
        ...
        <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-xl shadow p-4 text-white">
          <div class="flex justify-between items-center">
            <div>
              ...
              <p class="text-2xl font-bold">{{ $statistics['pending_orders'] }}</p>
            </div>
      ...
      <div class="bg-white rounded-xl shadow-lg p-6 mb-6">
        <h3 class="text-lg font-semibold mb-4 text-gray-800">Grafik Penjualan 6 Bulan Terakhir</h3>
          ...
          <table class="w-full">
            ...
            <tbody>
              ...
              <tr class="border-b hover:bg-gray-50">
                ...
                <td class="px-4 py-2 text-sm">{{ $order->created_at->format('d/m/Y H:i') }}</td>
                <td class="px-4 py-2 text-sm">{{ $order->items->sum('quantity') }} item</td>
  ...
  <script>
    ...
    setInterval(function() {
      fetch('{{ url("/dashboard/realtime-data") }}')
