...
<body class="bg-orange-50 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-xl bg-white shadow-lg rounded-xl p-8">
        ...
        <form action="{{ route('produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <!-- ✅ KODE PRODUK -->
            <div class="mb-4">
                <label for="kode_produk" class="block text-gray-700 font-semibold mb-1">Kode Produk</label>
            ...
            @if($produk->gambar)
                <div class="mb-4">
                    ...
                    <img src="{{ asset('storage/' . $produk->gambar) }}" class="w-32 h-32 object-cover rounded-md">
                </div>
            @endif

            <!-- Tombol -->
            <div class="flex justify-between">
                <a href="{{ url('/admin/produk') }}" class="flex items-center bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold px-4 py-2 rounded-lg">
