  ...
  <div class="flex flex-row pt-24 px-10 pb-4 gap-6">
    ...
    <div class="w-2/12">
      <div class="bg-white rounded-xl shadow-lg mb-6 px-6 py-4">
        <a href="<?php echo e(url('/admin/dashboard')); ?>" class="inline-block text-orange-600 bg-orange-50 rounded-lg my-2 w-full p-2 transition-all duration-200 hover:bg-orange-100">
          <span class="material-icons-outlined float-left pr-2">dashboard</span>
          Home
          <span class="material-icons-outlined float-right">keyboard_arrow_right</span>
        </a>
        <a href="<?php echo e(url('/admin/akun')); ?>" class="inline-block text-gray-600 hover:text-black hover:bg-gray-50 rounded-lg my-2 w-full p-2 transition-all duration-200">
          <span class="material-icons-outlined float-left pr-2">people</span>
          Kelola Akun Kasir
          <span class="material-icons-outlined float-right">keyboard_arrow_right</span>
        </a>
        <a href="<?php echo e(url('/admin/produk')); ?>" class="inline-block text-gray-600 hover:text-black hover:bg-gray-50 rounded-lg my-2 w-full p-2 transition-all duration-200">
          <span class="material-icons-outlined float-left pr-2">storefront</span>
          Kelola Produk
          <span class="material-icons-outlined float-right">keyboard_arrow_right</span>
        </a>
        <a href="<?php echo e(url('/admin/transaksi')); ?>" class="inline-block text-gray-600 hover:text-black hover:bg-gray-50 rounded-lg my-2 w-full p-2 transition-all duration-200">
          <span class="material-icons-outlined float-left pr-2">sync_alt</span>
          Pantau Transaksi
          <span class="material-icons-outlined float-right">keyboard_arrow_right</span>
        </a>
        <a href="<?php echo e(url('/admin/laporan')); ?>" class="inline-block text-gray-600 hover:text-black hover:bg-gray-50 rounded-lg my-2 w-full p-2 transition-all duration-200">
          <span class="material-icons-outlined float-left pr-2">bar_chart</span>
          Laporan Analitik
          <span class="material-icons-outlined float-right">keyboard_arrow_right</span>
        </a>
        <a href="<?php echo e(url('/admin/log-activity')); ?>" class="inline-block text-gray-600 hover:text-black hover:bg-gray-50 rounded-lg my-2 w-full p-2 transition-all duration-200">
      ...
      <div class="bg-white rounded-xl shadow-lg mb-6 px-6 py-4">
        <a href="<?php echo e(url('/admin/profil')); ?>" class="inline-block text-gray-600 hover:text-black hover:bg-gray-50 rounded-lg my-2 w-full p-2 transition-all duration-200">
            ...
            <div class="bg-white rounded-xl shadow-md p-6 card-hover">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e($akun->count()); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 card-hover">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e($akun->count() > 0 ? rand(1, $akun->count()) : 0); ?></p>
                    </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-white px-6 py-4 border-b border-gray-200">
                <div class="flex justify-between items-center flex-wrap gap-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Total <?php echo e($akun->count()); ?> akun terdaftar</p>
                    </div>
                    <a href="<?php echo e(url('/admin/akun/create')); ?>" class="btn-ripple bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-6 py-2.5 rounded-xl inline-flex items-center gap-2 shadow-md transition-all duration-300 hover:shadow-lg">
            ...
            <div class="p-6">
                <div class="overflow-x-auto rounded-xl border border-gray-100">
                    <table class="w-full table-auto">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            <?php $__currentLoopData = $akun; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="table-row-hover transition-all duration-200">
                                    <td class="p-4 text-sm text-gray-600 font-medium"><?php echo e($index + 1); ?></td>
                                    <td class="p-4">
                                        <div class="flex items-center gap-3">
                                            <div class="w-8 h-8 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full flex items-center justify-center text-white text-sm font-bold shadow-sm">
                                                <?php echo e(strtoupper(substr($item->username, 0, 1))); ?>

                                            </div>
                                            <span class="font-medium text-gray-800"><?php echo e($item->username); ?></span>
                                        </div>
                                    </td>
                                    <td class="p-4">
                                        <div class="flex items-center gap-2 group">
                                            <span class="text-gray-600 font-mono text-sm">••••••••</span>
                                            <button onclick="copyToClipboard('password-<?php echo e($index); ?>')" class="opacity-0 group-hover:opacity-100 transition-opacity duration-200 text-gray-400 hover:text-orange-600">
                                                <span class="material-icons-outlined text-sm">content_copy</span>
                                            </button>
                                            <span id="password-<?php echo e($index); ?>" class="hidden"><?php echo e($item->password ?? 'default123'); ?></span>
                                        </div>
                                    </td>
                                    <td class="p-4">
                                        <div class="flex gap-2">
                                            <a href="<?php echo e(url('/admin/akun/' . $item->id . '/edit')); ?>" class="inline-flex items-center gap-1 px-3 py-1.5 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 transition-all duration-200 text-sm font-medium">
                                                <span class="material-icons-outlined text-sm">edit</span>
                                                Edit
                                            </a>
                                            <form action="<?php echo e(url('/admin/akun/' . $item->id)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus akun <?php echo e($item->username); ?>? Data akan hilang secara permanen.')" class="inline">
                                                <?php echo csrf_field(); ?>
                                ...
                                <tr>
                                    <td colspan="4" class="p-12 text-center">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            <a href="<?php echo e(url('/admin/akun/create')); ?>" class="mt-2 inline-flex items-center gap-2 px-4 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors">
                ...
                <div class="flex justify-between items-center mt-6 pt-4 border-t border-gray-200">
                    <div class="text-sm text-gray-500">
                        Menampilkan <span class="font-medium">1</span> - <span class="font-medium"><?php echo e($akun->count()); ?></span> dari <span class="font-medium"><?php echo e($akun->count()); ?></span> data
                    </div>
                    <div class="flex gap-2">
...
</html><?php /**PATH C:\xampp\htdocs\apk_boba\resources\views/admin/akun.blade.php ENDPATH**/ ?>