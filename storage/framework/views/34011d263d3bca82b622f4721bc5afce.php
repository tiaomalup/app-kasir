    ...
    <input type="text" name="kode_produk" required
        ...
        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-400">
            ...
            <div class="flex justify-between">
                <a href="<?php echo e(url('admin/produk')); ?>" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold px-4 py-2 rounded-lg">
                    Batal
                </a>
...
<?php /**PATH C:\xampp\htdocs\apk_boba\resources\views/admin/create.blade.php ENDPATH**/ ?>