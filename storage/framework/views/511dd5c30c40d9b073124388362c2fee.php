    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center py-3">
            ...
            <div class="flex items-center space-x-4">
                <span class="text-gray-600">Kasir: <?php echo e(auth('kasir')->user()->name ?? 'Kasir'); ?></span>
                ...
                <a href="<?php echo e(route('kasir.logout')); ?>" 
...
<div class="bg-yellow-100 border-l-4 border-yellow-500 p-4 mx-4 mt-4">
    <div class="flex justify-between items-center">
        <div>
            <h3 class="font-bold text-yellow-800">🔧 DEBUG INFO - Order #<?php echo e($order->id); ?></h3>
            <div class="text-sm text-yellow-700 mt-1">
                <span class="inline-block mr-4"><strong>Status:</strong> 
                    ...
                    <?php else: ?>
                        <span class="text-red-600 font-bold"><?php echo e(strtoupper($order->status)); ?> (Tombol TIDAK muncul)</span>
                    <?php endif; ?>
                </span>
                <span class="inline-block mr-4"><strong>Payment Method:</strong> <?php echo e($order->payment_method ?? 'null'); ?></span>
                <span class="inline-block"><strong>Total:</strong> Rp <?php echo e(number_format($order->total, 0, ',', '.')); ?></span>
            </div>
        </div>
        <?php if($order->status == 'paid'): ?>
        <div>
            <a href="<?php echo e(route('kasir.struk', $order->id)); ?>" 
    ...
    <div class="max-w-4xl mx-auto">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium"><?php echo e($order->customer_id ?? 'Guest'); ?></span>
                            </div>
                            <div class="flex justify-between">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium"><?php echo e($order->payment_method ? ucfirst($order->payment_method) : '-'); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between">
                                ...
                                <span class="font-bold text-lg text-blue-600">Rp <?php echo e(number_format($order->total, 0, ',', '.')); ?></span>
                            </div>
                            <?php if($order->uang_masuk): ?>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Uang Masuk:</span>
                                <span class="font-medium">Rp <?php echo e(number_format($order->uang_masuk, 0, ',', '.')); ?></span>
                            </div>
                            <?php endif; ?>
                            <?php if($order->kembalian): ?>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Kembalian:</span>
                                <span class="font-medium text-green-600">Rp <?php echo e(number_format($order->kembalian, 0, ',', '.')); ?></span>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="p-6">
                        ...
                        <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                            ...
                            <ul class="text-green-700 text-sm space-y-1">
                                ...
                                <li>• Minimal pembayaran: Rp <?php echo e(number_format($order->total, 0, ',', '.')); ?></li>
                            </ul>
                        </div>
                        
                        <button onclick="bayarCash(<?php echo e($order->id); ?>)"
                                id="btn-cash"
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden payment-success">
                    ...
                    <div class="p-6">
                        ...
                        <button onclick="bayarQris(<?php echo e($order->id); ?>)"
                                id="btn-qris"
        ...
        <div class="flex justify-between items-center mt-8">
            ...
            <div class="text-sm text-gray-500">
                Dibayar pada: <?php echo e($order->paid_at ? $order->paid_at->format('d/m/Y H:i') : '-'); ?>
...
const totalAmount = <?php echo e($order->total); ?>;
...
</html><?php /**PATH C:\xampp\htdocs\apk_boba\resources\views/kasir/cari-pesanan.blade.php ENDPATH**/ ?>