...
<body class="min-h-screen bg-gradient-to-tr from-yellow-100 via-pink-100 to-yellow-200 flex items-center justify-center">
    ...
    <div class="w-full max-w-md bg-white rounded-3xl shadow-2xl p-10 relative border border-yellow-300">
        ...
        <!-- Form Login -->
        <form action="<?php echo e(route('kasir.login.submit')); ?>" method="POST" class="space-y-5">
            <?php echo csrf_field(); ?>
            <div>
        ...
        <p class="mt-6 text-center text-gray-400 text-xs">© <?php echo e(date('Y')); ?> Kasir Boba Ceria</p>
    </div>

</body>
</html>
<?php /**PATH C:\xampp\htdocs\apk_boba\resources\views/kasir/login_kasir.blade.php ENDPATH**/ ?>