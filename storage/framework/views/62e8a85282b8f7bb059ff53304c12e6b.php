                ...
                <tbody>
                    ...
                    <tr class="border-b hover:bg-orange-50">
                        ...
                        <td class="p-4 text-center">
                            <!-- Tombol Tambah Stok -->
                            <button onclick="openStockModal(<?php echo e($item->id); ?>, '<?php echo e($item->nama_produk); ?>', <?php echo e($item->stok); ?>)"
                            ...
                            <form action="<?php echo e(url('/admin/produk/' . $item->id)); ?>"
                                  method="POST" class="inline" 
                                  onsubmit="return confirm('Apakah Anda yakin ingin menghapus produk <?php echo e($item->nama_produk); ?>?')">
                                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\apk_boba\resources\views/admin/produk.blade.php ENDPATH**/ ?>