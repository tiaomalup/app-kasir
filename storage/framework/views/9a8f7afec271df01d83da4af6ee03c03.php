    ...
    <div class="bg-white shadow-lg rounded-xl p-8 w-full max-w-md">
        ...
        <form action="<?php echo e(route('profil.update')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" value="<?php echo e(old('name', $admin->name)); ?>" class="w-full mt-1 p-2 border rounded focus:outline-none focus:ring focus:border-blue-300" required>
            </div>

            <!-- Email -->
            <div class="mb-4">
                <label for="email" class="block font-medium text-gray-700">Email</label>
                <input type="email" id="email" name="email" value="<?php echo e(old('email', $admin->email)); ?>" class="w-full mt-1 p-2 border rounded focus:outline-none focus:ring focus:border-blue-300" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <?php if($admin->profile_picture): ?>
                    <img src="<?php echo e(asset($admin->profile_picture)); ?>" alt="Profile" class="mt-3 w-24 h-24 object-cover rounded-full">
                <?php endif; ?>
            </div>
...
<?php /**PATH C:\xampp\htdocs\apk_boba\resources\views/admin/edit_profil.blade.php ENDPATH**/ ?>