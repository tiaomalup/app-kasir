  ...
  <div class="flex flex-row pt-28 px-10 pb-8 gap-6">
    ...
    <div class="flex-1">
      ...
      <div class="flex flex-wrap justify-between items-center mb-6">
        ...
        <div class="bg-white/70 backdrop-blur-sm rounded-xl px-5 py-2 shadow-sm flex items-center gap-3 border border-orange-200">
          ...
          <div>
            ...
            <div class="text-2xl font-bold text-blue-900"><?php echo e(count($transaksis ?? [])); ?></div>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-orange-100/80 card-shadow-custom transition-all">
              ...
              <tr class="table-row-hover transition-all duration-150 group">
                ...
                <td class="p-4">
                  <div class="flex items-center gap-2">
                    ...
                    <span class="font-mono font-bold text-blue-700 tracking-wide text-sm">ORD-<?php echo e(str_pad($trx->id, 5, '0', STR_PAD_LEFT)); ?></span>
                  </div>
                </td>
                ...
                <td class="p-4">
                  <div class="font-bold text-gray-800 text-base">Rp <?php echo e(number_format($trx->total, 0, ',', '.')); ?></div>
                </td>
                ...
                <td class="p-4">
                  <div class="flex items-center gap-1.5">
                    ...
                    <?php endif; ?>
                    <span class="capitalize text-gray-700"><?php echo e($trx->payment_method ?? '-'); ?></span>
                  </div>
                </td>
                ...
                <td class="p-4">
                  <a href="<?php echo e(url('/admin/transaksi/' . $trx->id)); ?>" 
        ...
        <?php if(method_exists($transaksis, 'links') && $transaksis->hasPages()): ?>
        ...
        <div class="px-6 py-3 border-t border-gray-100 text-right text-xs text-gray-400 bg-gray-50/20">
          Menampilkan <?php echo e(count($transaksis ?? [])); ?> transaksi
        </div>
        <?php endif; ?>
      </div>
      ...
      <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="bg-white/80 rounded-xl p-3 flex items-center gap-3 shadow-sm border border-orange-100">
          ...
          <div>
            ...
            <p class="font-bold text-green-700"><?php echo e($transaksis->where('status','paid')->count() ?? 0); ?></p>
          </div>
        </div>
        <div class="bg-white/80 rounded-xl p-3 flex items-center gap-3 shadow-sm border border-orange-100">
          ...
          <div>
            ...
            <p class="font-bold text-amber-600"><?php echo e($transaksis->where('status','pending')->count() ?? 0); ?></p>
          </div>
        </div>
        <div class="bg-white/80 rounded-xl p-3 flex items-center gap-3 shadow-sm border border-orange-100">
          ...
          <div>
            ...
            <p class="font-bold text-blue-700">Rp <?php echo e(number_format($transaksis->where('status','paid')->sum('total'), 0, ',', '.')); ?></p>
          </div>
        </div>
      </div>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\apk_boba\resources\views/admin/pantau_transaksi.blade.php ENDPATH**/ ?>